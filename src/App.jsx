    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const { data: c, error: cErr } = await supabase.from('fb_categories').select('name');
                if (cErr) throw cErr;
            ...
            <header style={{ padding: '65px 25px 25px 25px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
                    ...
                    <div>
                        ...
                        <h1 style={{ margin: 0, fontSize: 26, fontWeight: '900', letterSpacing: -0.8 }}>Boshqaruv <small style={{ fontSize: 10, opacity: 0.8, color: T.accent, fontWeight: '1000' }}>v4.31 BOUTIQUE PRO</small></h1>
                    </div>
                </div>
